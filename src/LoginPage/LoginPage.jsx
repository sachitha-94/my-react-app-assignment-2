...
class LoginPage extends React.Component {
    ...
    handleSubmit(e) {
        ...
        const { username, password, user_role_id } = this.state;
        if (username && password && user_role_id) {
            this.props.login(username, password, user_role_id);
        }
    }

    render() {
        const { loggingIn } = this.props;
        const { username, password, submitted, user_role_id } = this.state;
        return (
            ...
            <div className="col-md-6 login-box">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user_role_id ? ' has-error' : '')}>
                        ...
                        <select className="form-control" name="user_role_id" value={user_role_id} onChange = {this.handleChange}>
